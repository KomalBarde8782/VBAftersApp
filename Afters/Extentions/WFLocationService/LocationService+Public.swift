...
extension LocationService {
    ...
    class func setLocationAccuracy(_ meters:Double) {
        LocationService.sharedInstance.LOCATION_ACCURACY = meters
    }
    
    //Defaulted to 10 seconds. Set here to update
    class func setLocationUpdateTimeLimit(_ seconds:Double) {
    ...
    */
    class func getCurrentLocationWithProgress(_ progress:LocationProgressBlock, onComplete complete:LocationProgressBlock, onFailure failure:((_ error:NSError)->())?) {
