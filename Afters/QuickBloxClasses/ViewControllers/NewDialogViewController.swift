...
//    }
//
//    internal override func setupUsers(users: [QBUUser]) {
...
//    }
//
//    private func updateDialog(dialog:QBChatDialog, newUsers users:[QBUUser], completion: ((_ response: QBResponse?, _ dialog: QBChatDialog?) -> Void)?) {
//
...
//     */
//    private func updatedMessageWithUsers(users: [QBUUser],isNewDialog:Bool) -> String {
//
...
//    }
//
//    private func nameForGroupChatWithUsers(users:[QBUUser]) -> String {
//
...
//    }
//
//    private func createChat(name: String?, users:[QBUUser], completion: ((_ response: QBResponse?, _ createdDialog: QBChatDialog?) -> Void)?) {
//
//        SVProgressHUD.show(withStatus: "Loading...", maskType: SVProgressHUDMaskType.clear)
//
//        if users.count == 1 {
...
//    }
//
//    private func openNewDialog(dialog: QBChatDialog!) {
//        self.dialog = dialog
...
//        cell.userEmailLabel.text = user.login ?? ""
